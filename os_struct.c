...
int init_os_struct(linux_info_ref info)
{
    ...
    info->LINUX_VMALLOC_START          = VMALLOC_START;
    info->LINUX_VMALLOC_END            = VMALLOC_END;
    info->LINUX_VMALLOC_SIZE_TB        = VMALLOC_SIZE_TB;
    info->LINUX_LDT_PGD_ENTRY_L4       = 0;
    info->LINUX_LDT_PGD_ENTRY_L5       = 0;
    info->LINUX_LDT_PGD_ENTRY          = LDT_PGD_ENTRY;
